...
const cards = [
  ...
  { title: "Custom Keywords", icon: Search, url: "/brand-data-room/keywords", summary: "18 keywords tracked across 3 categories.", updated: "5 days ago", complete: false, gradient: "from-amber-500/15 to-orange-500/10", explainer: "Custom Keywords: NOT FOR MVP. Tracks brand, competitor, and industry keywords for competitive intelligence. Would feed into AI concept generation as trend signals. Backend: keywords table with category grouping." },
];
