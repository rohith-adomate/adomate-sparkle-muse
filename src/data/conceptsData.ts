...
export const agentRuns: AgentRun[] = [
  {
    ...
    seen: false,
    concepts: [
      { id: "c1", title: "What if your soap was your deodorant?", source: "Manual Upload", status: "accepted", campaign: "Spring Fresh", imgSeed: "soap-deodorant" },
      { id: "c2", title: "The art of 3-in-1 freshness.", source: "Manual Upload", status: "pending", campaign: "Spring Fresh", imgSeed: "art-freshness" },
      { id: "c3", title: "Stop odor at the source, gently.", source: "Manual Upload", status: "pending", campaign: "Spring Fresh", imgSeed: "stop-odor" },
    ],
  },
  {
