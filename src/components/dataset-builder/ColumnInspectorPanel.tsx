    ...
    <div className="w-72 shrink-0 border-l border-border bg-card flex flex-col overflow-y-auto animate-slide-in-right">
      ...
      <div className="flex-1 p-4 space-y-5">
        ...
        <div>
          ...
          <Input
            value={column.name}
            onChange={(e) => onUpdateColumn({ ...column, name: e.target.value })}
        ...
        <div>
          ...
          <Textarea
            ...
            onChange={(e) => onUpdateColumn({ ...column, description: e.target.value })}
            placeholder="Describe what this column captures..."
            className="text-xs min-h-[60px] resize-none"
          />
        </div>

        {/* AI Prompt (AI columns only) */}
        {column.type === "ai" && column.aiPrompt && (
          <>
            ...
            <div>
              ...
              <div className="rounded-md border border-purple-200 bg-purple-50/50 p-3 text-[11px] text-foreground leading-relaxed whitespace-pre-wrap font-mono">
                {column.aiPrompt}
              </div>
            </div>
          </>
