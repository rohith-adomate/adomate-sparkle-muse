...
const MOCK_OUTPUTS: Record<string, { duration: string; timestamp: string; entries: { label: string; preview: string }[] }> = {
  ...
  "competitor-scrape": {
    ...
    timestamp: "Mar 10, 2026 09:01 AM",
    entries: [
      { label: "Competitors scraped", preview: "3 competitor profiles analyzed" },
      { label: "Ads found", preview: "27 active ads discovered" },
      { label: "Top themes", preview: "Seasonal discounts, lifestyle imagery, UGC-style creatives" },
      { label: "Average engagement", preview: "3.2% CTR across scraped ads" },
    ],
  },
  "generate-concepts": {
    duration: "14.3s",
    ...
    entries: [
      ...
      { label: "Concept 1", preview: "\"Winter Warmth\" — Cozy lifestyle shot with product overlay, warm tones" },
      { label: "Concept 2", preview: "\"Bold Statement\" — Minimalist design, large typography, brand pink accent" },
      { label: "Concept 3", preview: "\"Social Proof\" — UGC-style creative with testimonial overlay" },
